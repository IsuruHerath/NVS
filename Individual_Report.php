                ...
                foreach ($_POST['check_list'] as $selected) {
                    ...
                    switch ($selected) {
                        case 0:
                            ...
                            $row = mysqli_fetch_array($personalInfo);
                        ...
                        case 1:
                            ...
                            $pdf->SetFont('Times', '', 12);
                            $mobCount = 0;
                            while ($row = mysqli_fetch_array($contactNumbers)) {
                                $mobCount++;
                                if ($mobCount == 1)
                                    $pdf->Cell(30, 0, 'Contact Number', '0', '0', "L");
                                else
                                    $pdf->Cell(30, 0, ' ', '0', '0', "L");
                                $pdf->Cell(20, 0, ': ' . $row['number'], '0', '0', "L");
                                $pdf->Cell(0, 0, $row['type'], '0', '0', "L");
                                $pdf->SetY($pdf->GetY() + 10);
                            }

                            $row = mysqli_fetch_array($contactInfo);
                        ...
                        case 3:
                            ...
                            $row = mysqli_fetch_array($education);
                        ...
                        case 4:
                            ...
                            $row = mysqli_fetch_array($employment);
